$(function () {
    ...
    var options = {
        ...
        fill: {
            ...
            gradient: {
                shade: 'dark',
                gradientToColors: ['#ffd200', '#306844'],
                shadeIntensity: 1,
                type: 'vertical',
                stops: [0, 100, 100, 100]
            },
        },
        colors: ['#ff6a00', "#306844"],
        plotOptions: {
            bar: {
                horizontal: false,
                borderRadius: 4,
        ...
        tooltip: {
            ...
            y: {
                title: {
                    formatter: function () {
                        return ""; // No title, only value
                    }
                },
                formatter: function (value) {
                    return value + " members"; // Append 'members' to each value
                }
            },
            marker: {
                show: false
        ...
        xaxis: {
            ...
            labels: {
                ...
                formatter: function (val, index) {
                    // Show the month only for specific indices (e.g., first and last month)
                    if (index === 0 || index === 8) {
                        return val; // Show the month for the first and last data points
                    } else {
                        return ''; // Hide the month for other data points
                    }
                }
            }
        }
